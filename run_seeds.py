...
def run_one(task, settings_path, refine_path, log_path, vlm):
...
def main():
    ...
    parser.add_argument("--vlm", action="store_true",
                        help="Enable VLM feedback for this sweep")
    ...
    for n, seed in enumerate(args.seeds, start=1):
        ...
        started = time.time()
        code = run_one(args.task, settings_path, refine_path, seed_dir / "console.log", args.vlm)
